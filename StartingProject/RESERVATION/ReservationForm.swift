    ...
    var body: some View {
        VStack {
                ...
                HStack {
                    VStack(alignment: .leading) {
                        ...
                        TextField("",
                            ...
                            .keyboardType(.numberPad).onChange(of: $party.wrappedValue, perform: { newValue in
                                if newValue == 0 {
                                    $party.wrappedValue = 1
                                }
                            })
                    }
            ...
            .alert(isPresented: $showFormInvalidMessage) {
                Alert(title: Text("ERROR"), message: Text($errorMessage.wrappedValue))
            }
        }
        .onAppear {
